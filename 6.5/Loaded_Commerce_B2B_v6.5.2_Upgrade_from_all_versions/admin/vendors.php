...
if (tep_not_null($action)) {
  switch ($action) {
    ...
    case 'insert':
      ...
      $vendors_image_name = isset($_FILES['vendors_image']['name']) ? $_FILES['vendors_image']['name'] : '';
      ...
      if ($action == 'edit' || $action == 'update' || $action == 'new' || $action == 'insert' || $action == 'setflag') {
        ...
        <tr>
          <td><table width="50%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="formArea"><table width="100%" border="1" cellspacing="2" cellpadding="2">
                <tr>            
        ...
        <tr>
          ...
          <td class="main" width="25%"><?php echo TEXT_VENDORS_SEND_EMAIL; ?></td>
          <td class="main">
            <?php
        ...
        <tr>
          <td colspan="2" class="main"><table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td valign="top" class="main" align="top"><?php echo TEXT_VENDORS_IMAGE; ?>
              <td class="main">
                <?php 
                echo tep_draw_separator('pixel_trans.gif', '75', '15') . tep_draw_file_field('vendors_image') . tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $vInfo->vendors_image . tep_draw_hidden_field('previous_vendors_image', $vInfo->vendors_image);
        ...
        <tr>
          <td colspan="2" align="center" class="main">
            <?php
            if ($action == 'new') { 
              echo '<a href="' . tep_href_link(FILENAME_VENDORS, tep_get_all_get_params(array('action'))) .'">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>' . tep_image_submit('button_insert.gif', IMAGE_INSERT); 
            } else { 
              echo '<a href="' . tep_href_link(FILENAME_VENDORS, tep_get_all_get_params(array('action'))) .'">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>' . tep_image_submit('button_update.gif', IMAGE_UPDATE); 
            }
            ?>
          </td></form>
        </tr>
            ...
            <tr>
                ...
                <tr>
                  <td colspan="4"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                    ...
                    if (isset($_GET['search']) && tep_not_null($_GET['search'])) {
                      ?>
                      <tr>
                        <td align="right" colspan="2"><?php echo '<a href="' . tep_href_link(FILENAME_VENDORS) . '">' . tep_image_button('button_reset.gif', IMAGE_RESET) . '</a>'; ?></td>
                      </tr>
                      <?php
                    } else {
                      ?>
                      <tr>
                        <td align="right" colspan="2"> 
                          <?php echo '<a href="' . tep_href_link(FILENAME_VENDORS, 'action=new') . '">' . tep_image_button('button_new_product.gif', IMAGE_NEW_VENDOR) . '</a>'; ?>
                        </td>
                      </tr>
                      <?php
                    }
              ...
              switch ($action) {
                case 'confirm':
                  ...
                  $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(FILENAME_VENDORS, tep_get_all_get_params(array('vendors_id', 'action')) . 'vendors_id=' . $vInfo->vendors_id) . '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>' . tep_image_submit('button_delete.gif', IMAGE_DELETE));
                  break;
                default:
