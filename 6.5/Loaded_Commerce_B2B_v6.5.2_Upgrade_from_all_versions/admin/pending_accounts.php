...
if (tep_not_null($action)) {
  switch ($action) {
    ...
    case 'deleteconfirm':
      ...
      break;
    case 'approve_pending_customers':
      tep_db_query("update " . TABLE_CUSTOMERS . " set customers_account_approval = 'Approve' where customers_account_approval = 'Pending'");
      tep_redirect(tep_href_link(FILENAME_PENDING_ACCOUNTS, tep_get_all_get_params(array('cID', 'action'))));
      break;
    default:
          ...
          <td class="formArea"><table border="0" cellspacing="2" cellpadding="2">
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="main">
                  <?php 
                  if (B2B_REQUIRE_ACCOUNT_APPROVAL=='Requires Approval') {
          ...
          <tr>
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="right"><?php 
                  if ($_REQUEST['filterstatus'] == 'Deny') {
                    echo tep_draw_separator('pixel_trans.gif', '1', '10');
                  } else {
                    echo '<a href="' . tep_href_link(FILENAME_PENDING_ACCOUNTS,'action=approve_pending_customers') . '">' . tep_image_button('button_reset.gif', IMAGE_APPROVE_PENDING_CUSTOMERS) . '</a>';
                  }                  
                  ?>
                </td>
              ...
              <tr>
                <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr class="dataTableHeadingRow">
                    ...
                    ?>
                    <td class="dataTableHeadingContent" valign="top"><a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=company') . $oscid; ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . ENTRY_COMPANY . ' --> A-B-C From Top '); ?></a>&nbsp;<a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=company-desc') . $oscid; ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . ENTRY_COMPANY . ' --> Z-X-Y From Top '); ?></a><br><?php echo ENTRY_COMPANY; ?></td>
                    <td class="dataTableHeadingContent" valign="top"><a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=lastname') . $oscid; ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . TABLE_HEADING_LASTNAME . ' --> A-B-C From Top '); ?></a>&nbsp;<a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=lastname-desc') . $oscid; ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . TABLE_HEADING_LASTNAME . ' --> Z-X-Y From Top '); ?></a><br><?php echo TABLE_HEADING_LASTNAME; ?></td>
                    <td class="dataTableHeadingContent" valign="top"><a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=firstname') . $oscid; ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . TABLE_HEADING_FIRSTNAME . ' --> A-B-C From Top '); ?></a>&nbsp;<a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=firstname-desc') . $oscid; ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . TABLE_HEADING_FIRSTNAME . ' --> Z-X-Y From Top '); ?></a><br><?php echo TABLE_HEADING_FIRSTNAME; ?></td>
                    <td class="dataTableHeadingContent" valign="top"><a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=entry_state') . $oscid; ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . TABLE_HEADING_CUSTOMERS_STATE . ' --> A-B-C From Top '); ?></a>&nbsp;<a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=entry_state-desc') . $oscid; ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . TABLE_HEADING_CUSTOMERS_STATE . ' --> Z-X-Y From Top '); ?></a><br><?php echo TABLE_HEADING_CUSTOMERS_STATE; ?></td>
                    <td class="dataTableHeadingContent" align="right" valign="top"><a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=customers_telephone') . $oscid; ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . TABLE_HEADING_CUSTOMERS_PHONE . ' --> 1-2-3 From Top '); ?></a>&nbsp;<a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=id-desc') . $oscid; ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . TABLE_HEADING_CUSTOMERS_PHONE . ' --> 3-2-1 From Top '); ?></a><br><?php echo TABLE_HEADING_CUSTOMERS_PHONE; ?></td>
                    <td class="dataTableHeadingContent" align="left" valign="top"><a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=customers_email_address') . $oscid; ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . TABLE_HEADING_CUSTOMERS_EMAIL . ' --> customers_email_address first (to Top) '); ?></a>&nbsp;<a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=customers_email_address-desc') . $oscid; ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . TABLE_HEADING_CUSTOMERS_EMAIL . ' --> customers_email_address last (to Bottom)'); ?></a><br><?php echo TABLE_HEADING_CUSTOMERS_EMAIL; ?>&nbsp;</td>
