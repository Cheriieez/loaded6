...
*/
  ...
  global $oInfo;
  $rci .= '<br /><a href="' . tep_href_link(FILENAME_CHANGE_PASSWORD, 'selected_box=customers&customer=' . $oInfo->customers_id) . '">' . tep_image_button('button_change_password.png', IMAGE_CHANGE_PASSWORD) . '</a>';
