...
<script type="text/javascript">
  function form_validate() {
    var msg_str = '';   
    if(document.zones.warehouse_zone_name.value == '') {
      msg_str += "\r\nPlease enter the warehouse zone name";
    }
    if(document.zones.warehouse_zone_zip_code.value == '') {
      msg_str += "\r\nPlease enter the warehouse zone zip code";
    }
            ...
            if ($action == 'list') {
              ...
              switch ($action) {
                case 'new_zone':
                  ...
                  $contents = array('form' => tep_draw_form('zones', FILENAME_WAREHOUSE_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID'] . '&action=insert_zone','post','onSubmit="return form_validate();"'));
                ...
                case 'edit_zone':
                  ...
                  $contents = array('form' => tep_draw_form('zones', FILENAME_WAREHOUSE_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $zInfo->warehouse_zone_id . '&action=save_zone','post','onSubmit="return form_validate();"'));
