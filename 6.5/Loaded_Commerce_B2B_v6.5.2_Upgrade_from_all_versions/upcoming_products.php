<?php
/*
  $Id: upcoming_products.php,v 1.1.1.1 2004/03/04 23:38:02 ccwjr Exp $
...
*/
  ...
  $column_list = array('PRODUCT_LIST_DATE_EXPECTED');
  reset($define_list);
  ...
  $listing_sql = "SELECT DISTINCT " . $select_column_list . "
                          ...
                          p.products_image ";
  if ($need_price === true) {
    $listing_sql .= "    , p.products_price, p.products_tax_class_id, products_date_available,
