...
print("customer_group_id : ".$customer_group_id."<br>");


if ($display_mode == 'categories') {
  $pages_category_query = tep_db_query("select icd.categories_name, ic.categories_image from " . TABLE_PAGES_CATEGORIES_DESCRIPTION . " icd, " . TABLE_PAGES_CATEGORIES . " ic where ic.categories_id = icd.categories_id and icd.categories_id = '" . (int)$cID . "' and icd.language_id = '" . (int)$languages_id . "' and ic.categories_status = '1'  and ic.products_group_access like '%". $customer_group_id."%'");
...
<?php
  $pages_query = tep_db_query("select ip.pages_id, ipd.pages_title, ipd.pages_blurb
                               ...
                               where ip.pages_status = '1'
                                 ...
                                 and ipd.language_id = '" . (int)$languages_id . "'  and ip.products_group_access like '%". $customer_group_id."%'
                              ");
...
<?php
  ...
  $pages_page_query = tep_db_query("select ipd.pages_id, ipd.pages_title, ipd.pages_body from " . TABLE_PAGES_DESCRIPTION . " ipd, " . TABLE_PAGES . " ip where ip.pages_id = ipd.pages_id and ipd.pages_id = '" . (int)$pID . "' and ipd.language_id = '" . (int)$languages_id . "' and ip.pages_status = '1'  and ip.products_group_access like '%". $customer_group_id."%'");
...
?>
  ...
  <tr>
     <td class="main">
<?php
  $pages_categories_query = tep_db_query("select ic.categories_id, icd.categories_name, icd.categories_description from " . TABLE_PAGES_CATEGORIES . " ic, " . TABLE_PAGES_CATEGORIES_DESCRIPTION . " icd  where icd.categories_id = ic.categories_id and icd.language_id = '" . (int)$languages_id . "' and ic.categories_status = '1'  and c.products_group_access like '%". $customer_group_id."%'");

  // pages outside categories
  $pages_query = tep_db_query("select ip.pages_id, ipd.pages_title, ipd.pages_blurb from " . TABLE_PAGES . " ip,
                                    " . TABLE_PAGES_DESCRIPTION . " ipd,
                                    " . TABLE_PAGES_TO_CATEGORIES . " ip2c
                               where ip.pages_status = '1'
                                 and ipd.pages_id = ip.pages_id
                                 ...
                                 and ipd.language_id = '" . (int)$languages_id . "' and  and ip.products_group_access like '%". $customer_group_id."%'
