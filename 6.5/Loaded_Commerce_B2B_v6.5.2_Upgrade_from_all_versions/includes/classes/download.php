...
class download {
  ...
  function process($current_file_id) {
    ...
    if (isset($_SESSION['customer_id'])) {
      ...
      $order_status_array = preg_split('/,/', LIBRARY_DOWNLOAD_ORDER_STATUS_CONTROL);
      $orders_status = '';
      ...
      if (FDM_REQ_PRODUCT_OPERATORS == 'or') {
        ...
        $pur_query = tep_db_query("SELECT o.orders_id 
                                                  ...
                                                  WHERE ".((!empty($_GET['order_id'])) ? "o.orders_id = '".(int)$_GET['order_id']."' and " : '')." o.orders_id = op.orders_id 
