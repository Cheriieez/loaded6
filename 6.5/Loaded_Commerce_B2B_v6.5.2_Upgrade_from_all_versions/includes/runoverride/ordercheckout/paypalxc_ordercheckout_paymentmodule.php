...
*/
global $payment_modules,$style1,$style2;

$service = MODULE_PAYMENT_PAYPAL_SERVICE;
$ec_enabled = (defined('MODULE_PAYMENT_PAYPAL_STATUS') && MODULE_PAYMENT_PAYPAL_STATUS == 'True' && MODULE_PAYMENT_PAYPAL_SERVICE == 'Express Checkout') ? true : false;
...
if ($_SESSION['xcSet']) {
  $payment_modules->modules = array(0 => 'paypal_xc.php'); 
...
<tr>
  <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
    <tr class="infoBoxContents">
      <td><table border="0" width="100%" cellspacing="0" cellpadding="2" id = "id_div_payment_hide" <?php echo $style1; ?>>
        <?php
        ...
        if ( $ec_enabled ) {
          ...
          <tr>
            ...
            <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              ?>
              <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              <td class="main" colspan="3"><table><tr><td><b><?php echo MODULE_PAYMENT_PAYPAL_DP_TEXT_TITLE; ?></b></td><td><img src="<?php echo MODULE_PAYMENT_PAYPAL_EC_MARK_IMG; ?>"></td><td><?php echo MODULE_PAYMENT_PAYPAL_XC_LEARN_MORE_LINK; ?></td></tr></table></td>
              <td class="main" align="right">
                <?php 
                if ($radio_buttons > 0 ) {
