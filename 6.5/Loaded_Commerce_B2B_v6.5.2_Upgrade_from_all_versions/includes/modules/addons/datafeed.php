...
*/
  ...
  class datafeed {
    ...
    function install() {
      ...
      tep_db_query("INSERT IGNORE INTO `configuration` (`configuration_title`, `configuration_key`, `configuration_value`, `configuration_description`, `configuration_group_id`, `sort_order`, `set_function`, `date_added`) VALUES ('Enable LC Data Feed Module', 'MODULE_ADDONS_DATAFEED_STATUS', 'True', 'Select True to enable LC Data Feed Management Module.', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
