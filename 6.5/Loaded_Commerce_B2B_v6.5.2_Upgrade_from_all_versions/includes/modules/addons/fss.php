...
*/
  ...
  class fss {
    ...
    function install() {
      ...
      tep_db_query("CREATE TABLE IF NOT EXISTS fss_fields_to_forms (
                    forms_id int(11) NOT NULL AUTO_INCREMENT,
                    fields_id int(11) NOT NULL DEFAULT '0',
                    PRIMARY KEY (forms_id,fields_id)
                  ) ENGINE=MyISAM DEFAULT CHARSET=latin1");
      ...
      tep_db_query("CREATE TABLE IF NOT EXISTS fss_forms_fields (
                    fields_id int(11) NOT NULL AUTO_INCREMENT,
                    fields_name varchar(40) NOT NULL DEFAULT '',
                    fields_type varchar(40) NOT NULL DEFAULT '',
                    fields_required tinyint(1) NOT NULL DEFAULT '1',
...
*/
      ...
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_FORMS_FIELDS", "fss_forms_fields", "", 491, 1, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_FIELDS_TO_FORMS", "fss_fields_to_forms", "", 491, 2, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_FORMS", "fss_forms", "", 491, 3, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_FORMS_POSTS", "fss_forms_posts", "", 491, 4, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_FORMS_POSTS_CONTENT", "fss_forms_posts_content", "", 491, 5, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_FORMS_POSTS_NOTES", "fss_forms_posts_notes", "", 491, 7, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_FORMS_POSTS_STATUS", "fss_forms_posts_status", "", 491, 8, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_QUESTIONS", "fss_questions", "", 491, 9, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_QUESTIONS_DESCRIPTION", "fss_questions_description", "", 491, 10, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_VALUES_FIELDS", "fss_values_fields", "", 491, 11, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_FIELDS_TO_VALUES", "fss_fields_to_values", "", 491, 13, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_QUESTIONS_FIELDS_VALUES", "fss_questions_fields_values", "", 491, 14, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_QUESTIONS_TO_FORMS", "fss_questions_to_forms", "", 491, 15, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_CATEGORIES", "fss_categories", "", 491, 16, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_FORMS_TO_CATEGORIES", "fss_forms_to_categories", "", 491, 17, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "TABLE_FSS_FORMS_DESCRIPTION", "fss_forms_description", "", 491, 18, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_MENU", "fss_menu.php", "", 491, 30, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_QUESTION_MANAGER", "fss_question_manager.php", "", 491, 31, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_VALUES_MANAGER", "fss_values_manager.php", "", 491, 32, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_FORMS_BUILDER", "fss_forms_builder.php", "", 491, 33, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_POST_MANAGER", "fss_post_manager.php", "", 491, 34, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_CONFIG", "fss_configuration.php", "", 491, 35, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_BACKUP_RESTORE", "fss_backup_restore.php", "", 491, 36, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_FORMS_POSTS_ADMIN", "fss_forms_posts_admin.php", "", 491, 37, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_FIELDS_ADMIN", "fss_fields_admin.php", "", 491, 38, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "CONTENT_FSS_FORMPOST_CONTACT_US", "fss_fp_contact_us", "", 491, 39, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_FORMPOST_CONTACT_US", "fss_fp_contact_us.php", "", 491, 40, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "CONTENT_FSS_FORMS_INDEX", "fss_forms_index", "", 491, 41, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_FORMS_INDEX", "fss_forms_index.php", "", 491, 42, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FORMS_LISTING_COL", "fss_forms_listing_col.php", "", 491, 43, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "CONTENT_FSS_FORMS_DETAIL", "fss_forms_detail", "", 491, 44, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_FORMS_DETAIL", "fss_forms_detail.php", "", 491, 45, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_FUNCTIONS", "fss_functions.php", "", 491, 46, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "CONTENT_FSS_FORMS_POST_SUCCESS", "fss_forms_post_success", "", 491, 47, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_FORMS_POST_SUCCESS", "fss_forms_post_success.php", "", 491, 48, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_QUESTIONS_PREVIEW", "fss_questions_preview.php", "", 491, 49, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_REPORTS", "fss_reports.php", "", 491, 50, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_VIEW_CUSTOMERS", "fss_view_customers.php", "", 491, 51, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_VIEW_ORDERS", "fss_view_orders.php", "", 491, 52, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_ADDITIONAL_INFORMATION", "fss_additional_information.php", "", 491, 53, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_UNCOMPLETED_SURVEYS", "fss_uncompleted_surveys.php", "", 491, 54, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_COMPLETED_SURVEYS", "fss_completed_surveys.php", "", 491, 55, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "CONTENT_FSS_ADDITIONAL_INFORMATION", "fss_additional_information", "", 491, 56, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "CONTENT_FSS_UNCOMPLETED_SURVEYS", "fss_uncompleted_surveys", "", 491, 57, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "CONTENT_FSS_COMPLETED_SURVEYS", "fss_completed_surveys", "", 491, 58, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_SURVEYS_LISTING_COL", "fss_surveys_listing_col.php", "", 491, 59, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "FILENAME_FSS_SURVEYS_INFO", "fss_surveys_info.php", "", 491, 60, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "", "CONTENT_FSS_SURVEYS_INFO", "fss_surveys_info", "", 491, 61, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "Upload file directory", "FSS_UPLOAD_FILE_PATH", "pub/", "The directory that stores the customer upload files", 490, 10, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "Forms Administrator Email", "FSS_FORMS_ADMIN_EMAIL", "", "The email address for forms administrator", 490, 20, now(), now())'); 
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "Forms Administrator Full Name", "FSS_FORMS_ADMIN_FULLNAME", "", "The fullname for forms administrator", 490, 30, now(), now())');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ("", "Copy all Forms to Email", "FSS_FORMS_COPY_ALL_EMAIL", "", "This will send all admin notices to this email as well as the email specified on each form.", 490, 40, now(), now())'); 
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ("", "Debug Mode", "FSS_FORMS_DEBUG_MODE", "false", "Enable debug mode?", 490, 50, now(), now(), NULL, "tep_cfg_select_option(array(""true"", ""false""),");');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ("", "Survey - Only Allow One per Customer", "FSS_SURVEY_ONLY_ALLOW_ONE", "true", "Only allow one survey per customer", 490, 60, now(), now(), NULL, "tep_cfg_select_option(array(""true"", ""false""),");'); 
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ("", "Survey - Require Login", "FSS_SURVEY_REQUIRE_LOGIN", "false", "Require login for survey", 490, 70, now(), now(), NULL, "tep_cfg_select_option(array(""true"", ""false""),");');
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ("", "System Account Form - Customer Alert", "FSS_FORMS_ACCOUNT_CUSTOMER_ALERT", "false", "Display a message in the top of the checkout and account pages, when there are new fields in their My Account System form that they have not filled out.", 490, 80, now(), now(), NULL, "tep_cfg_select_option(array(""true"", ""false""),");'); 
      tep_db_query('INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ("", "System Account Form - Require Update", "FSS_FORMS_ACCOUNT_REQUIRE_UPDATE", "false", "Redirect a customer during checkout to the My Account -> System Form page to update additional or unanswered questions there during checkout.", 490, 90, now(), now(), NULL, "tep_cfg_select_option(array(""true"", ""false""),");');
    }
