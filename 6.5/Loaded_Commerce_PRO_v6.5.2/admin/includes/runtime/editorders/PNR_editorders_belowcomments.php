<?php
/*
  $Id: PNR_editorders_belowcomments.php,v 1.0.0.0 2007/08/16 13:41:11 maestro Exp $
...
<?php
  $p_status_query = tep_db_query("SELECT points_status FROM " . TABLE_CUSTOMERS_POINTS_PENDING . " WHERE points_status = 1 AND points_type = 'SP' AND orders_id = '" . (int)$_GET['oID'] . "'");
