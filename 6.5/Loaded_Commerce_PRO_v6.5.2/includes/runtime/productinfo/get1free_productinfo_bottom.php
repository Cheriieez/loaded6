<?php
/*
  $Id: get1free_productinfo_bottom.php,v 1.1.0.0 2008/03/11 13:41:11 maestro Exp $
  ...
  if (defined('MODULE_ADDONS_GET1FREE_STATUS') && MODULE_ADDONS_GET1FREE_STATUS == 'True') {
    ...
    if(defined('GET1FREE_PRODUCTINFO_PLACEMENT') && GET1FREE_PRODUCTINFO_PLACEMENT == 'bottom') {
      ...
      if (tep_db_num_rows($get_1_free_query) > 0) {
        ...
        echo '<tr><td align="center" width="98%"><div id="get1free" style="padding:4px; border:1px dashed #ff0000; background-color:pink; font-size:16px;">' . sprintf(TEXT_GET_1_FREE_PROMOTION, $free_product['products_qualify_quantity'], $name['products_name'], $free_product['products_free_quantity'], $free_url) . '</div></td></tr>';
      }
      // end Get 1 Free
    } //end placement check
