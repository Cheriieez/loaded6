<?php
/*
  $Id: get1free_productinfotabs_top.php,v 1.1.0.0 2008/03/11 13:41:11 maestro Exp $
...
*/
  ...
  if (defined('MODULE_ADDONS_GET1FREE_STATUS') && MODULE_ADDONS_GET1FREE_STATUS == 'True') {
    // check for placement
    if (defined('GET1FREE_PRODUCTINFO_PLACEMENT') && GET1FREE_PRODUCTINFO_PLACEMENT == 'top') {
      // start Get 1 Free
      ...
      if (tep_db_num_rows($get_1_free_query) > 0) {
        ...
        echo '<table cellpadding="0" cellspacing="0" border="0" width="99%"><tr><td align="center"><div id="get1free" style="padding:4px; border:1px dashed #ff0000; margin-top:10px; margin-bottom:-10px; background-color:pink; font-size:16px;">' . sprintf(TEXT_GET_1_FREE_PROMOTION, $free_product['products_qualify_quantity'], $name['products_name'], $free_product['products_free_quantity'], $free_url) . '</div></td></tr></table>';
      }
      // end Get 1 Free
    } //end placement check
