...
CREATE TABLE admin_files (
  ...
  admin_groups_id set('1','2','3','4','5','6') NOT NULL DEFAULT '1',
  PRIMARY KEY (admin_files_id)
) ENGINE=MyISAM DEFAULT COLLATE=latin1_swedish_ci AUTO_INCREMENT=2302;
...
#
# Table structure for: affiliate_affiliate
#
CREATE TABLE affiliate_affiliate (
  ...
  affiliate_template varchar(25) DEFAULT NULL,
  affiliate_cobrand_image varchar(64) NOT NULL DEFAULT '',
  affiliate_cobrand_name varchar(128) NOT NULL DEFAULT '',
  affiliate_cobrand_slogan varchar(96) NOT NULL DEFAULT '',
  affiliate_cobrand_url varchar(255) NOT NULL DEFAULT '',
  affiliate_cobrand_support_email varchar(128) NOT NULL DEFAULT '',
  affiliate_cobrand_support_phone varchar(16) NOT NULL DEFAULT '',
  PRIMARY KEY (affiliate_id)
) ENGINE=MyISAM DEFAULT COLLATE=latin1_swedish_ci;


#
# Table structure for: affiliate_banners
#
CREATE TABLE affiliate_banners (
  ...
  affiliate_banners_html_text text DEFAULT NULL,
  affiliate_expires_impressions int(7) DEFAULT '0',
  affiliate_expires_date datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  affiliate_date_scheduled datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  affiliate_date_added datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  affiliate_date_status_change datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
#
# Table structure for: affiliate_banners_history
#
...
#
# Table structure for: affiliate_clickthroughs
#
CREATE TABLE affiliate_clickthroughs (
  ...
  affiliate_clientreferer varchar(200) DEFAULT 'None Detected (Perhaps a direct link)',
  affiliate_products_id int(11) NOT NULL DEFAULT '0',
...
#
# Table structure for: affiliate_news
#
...
#
# Table structure for: affiliate_news_contents
#
...
#
# Table structure for: affiliate_newsletters
#
...
#
# Table structure for: affiliate_payment
#
...
#
# Table structure for: affiliate_payment_status
#
...
#
# Table structure for: affiliate_payment_status_history
#
CREATE TABLE affiliate_payment_status_history (
  ...
  affiliate_date_added datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  affiliate_notified tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (affiliate_status_history_id)
) ENGINE=MyISAM DEFAULT COLLATE=latin1_swedish_ci;


#
# Table structure for: affiliate_sales
#
...
CREATE TABLE articles (
  ...
  products_group_access varchar(64) NOT NULL DEFAULT 'G,0',
...
) ENGINE=MyISAM DEFAULT COLLATE=latin1_swedish_ci AUTO_INCREMENT=3303;
...
#
# Table structure for: customer_groups_description
#
CREATE TABLE customer_groups_description (
...
CREATE TABLE customers (
  ...
  customers_group_id smallint(5) unsigned NOT NULL DEFAULT '0',
  customers_access_group_id varchar(255) NOT NULL DEFAULT 'G,0',
  ...
  customers_account_approval enum('Approve','Pending','Deny') NOT NULL DEFAULT 'Pending',
...
#
# Table structure for: customers_comments
#
CREATE TABLE customers_comments (
  customers_comments_id int(11) NOT NULL auto_increment,
  customers_id int(11) NOT NULL DEFAULT '0',
  admin_id int(11) NOT NULL DEFAULT '0',
  admin_name varchar(64) NOT NULL DEFAULT '',
  comments text NOT NULL DEFAULT '',
  date_added datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (customers_comments_id),
...
#
# Table structure for: customers_groups
#
CREATE TABLE customers_groups (
  ...
  group_template varchar(25) DEFAULT NULL,
  group_discount float(11,5) NOT NULL DEFAULT '0.00000',
  group_discount_QTY_Breaks int(5) NOT NULL DEFAULT '0',
  group_hide_show_prices tinyint(1) NOT NULL DEFAULT '1',
  group_access tinyint(1) NOT NULL DEFAULT '1',
  group_price tinyint(1) NOT NULL DEFAULT '1',
...
#
# Table structure for: orders_shipping
#
...
CREATE TABLE products (
  ...
  vendors_prod_comments text DEFAULT NULL,
...
CREATE TABLE products_description (
  ...
  language_id int(11) NOT NULL DEFAULT '1',
  products_name varchar(128) NOT NULL DEFAULT '',
  products_blurb text DEFAULT NULL,
...
#
# Table structure for: products_groups
#
...
#
# Table structure for: refund_method
#
...
#
# Table structure for: return_reasons
#
...
#
# Table structure for: returns_products_attributes_data
#
CREATE TABLE returns_products_attributes_data (
  returns_products_attributes_id int(11) NOT NULL auto_increment,
  returns_id int(11) NOT NULL DEFAULT '0',
  returns_products_id int(11) NOT NULL DEFAULT '0',
  products_options varchar(32) NOT NULL DEFAULT '',
  products_options_values varchar(64) NOT NULL DEFAULT '',
  options_values_price decimal(15,4) NOT NULL DEFAULT '0.0000',
  price_prefix char(1) NOT NULL DEFAULT '',
  products_options_id int(11) NOT NULL DEFAULT '0',
  products_options_values_id int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (returns_products_attributes_id)
) ENGINE=MyISAM DEFAULT COLLATE=latin1_swedish_ci;


#
# Table structure for: returns_products_data
#
...
#
# Table structure for: returns_status
#
CREATE TABLE returns_status (
  returns_status_id int(11) NOT NULL DEFAULT '0',
  language_id int(11) NOT NULL DEFAULT '1',
...
#
# Table structure for: returns_status_history
#
CREATE TABLE returns_status_history (
  returns_status_history_id int(11) unsigned NOT NULL auto_increment,
  returns_id int(11) NOT NULL DEFAULT '0',
  returns_status int(11) NOT NULL DEFAULT '0',
  date_added datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  customer_notified tinyint(1) unsigned DEFAULT '0',
  comments text DEFAULT NULL,
...
#
# Table structure for: returns_total
#
...
#
# Table structure for: vendor_configuration
#
...
CREATE TABLE vendors (
  ...
  vendors_comments text DEFAULT NULL,
  ...
  vendor_add_info text DEFAULT NULL,
  account_number varchar(32) DEFAULT NULL,
...
#
# Table structure for: vendors_info
#
...
CREATE TABLE warehouse_zones (
  warehouse_zone_id int(11) NOT NULL auto_increment,
  warehouse_zone_name varchar(32) NOT NULL DEFAULT '',
  warehouse_zone_description varchar(255) NOT NULL DEFAULT '',
  warehouse_zone_zip_code varchar(32) NOT NULL DEFAULT '',
  last_modified datetime DEFAULT NULL,
  date_added datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
#
# Table structure for: zones_to_warehouse_zones
#
CREATE TABLE zones_to_warehouse_zones (
  association_id int(11) NOT NULL auto_increment,
  zone_country_id int(11) NOT NULL DEFAULT '0',
  zone_id int(11) DEFAULT NULL,
  warehouse_zone_id int(11) DEFAULT NULL,
  last_modified datetime DEFAULT NULL,
  date_added datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (association_id)
) ENGINE=MyISAM DEFAULT COLLATE=latin1_swedish_ci;
