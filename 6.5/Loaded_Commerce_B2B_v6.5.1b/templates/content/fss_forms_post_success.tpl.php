...
<table border="0" width="100%" cellspacing="0" cellpadding="<?php echo CELLPADDING_SUB; ?>">
  ...
  <tr>
    <td><table width="100%">
      <tr>
        <td align="right"><?php echo '<a href="' . (isset($_SESSION['customer_id']) ? tep_href_link(FILENAME_ACCOUNT, '', 'SSL') : tep_href_link(FILENAME_DEFAULT, '', 'NONSSL')) . '">' . tep_template_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?></td>
      </tr>
    </table></td>
  </tr>
</table>
