...
echo $cre_RCI->get('tellafriend', 'top');
// RCI code eof
echo tep_draw_form('email_friend', tep_href_link(FILENAME_TELL_A_FRIEND, 'action=process&amp;products_id=' . (int)$_GET['products_id']));
?>
...
<?php
// RCI code start
echo $cre_RCI->get('tellafriend', 'menu');
// RCI code eof
// BOF: Lango Added for template MOD
if (MAIN_TABLE_BORDER == 'yes'){
...
?>
             <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . (int)$_GET['products_id']) . '">' . tep_template_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
...
<?php
// RCI code start
echo $cre_RCI->get('tellafriend', 'bottom');
