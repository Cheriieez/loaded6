...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
<?php
if(isset($_GET['b2bwarning']) && $_GET['b2bwarning'] === '1')
{
  echo "<td class='main'>".TEXT_ACCOUNT_B2BWARNING."</td>";
}
elseif (($_GET['pass'] != '') && ($_GET['verifyid'] != '')){
...
?>            <td class="main">
<?php 
  echo TEXT_YOUR_ACCOUNT_ALREADY_EXIST . '<br>'; 
?></td>
