      ...
      <tr>
        <td><table class="ticket" width="100%" border="1" cellspacing="0" cellpadding="2">
          ...
          <tr>
            ...
            <td class="main" align="right" valign="top" style="padding: 5px;"><?php echo tep_image_submit('button_update.gif', IMAGE_UPDATE) . '&nbsp;<a href="' . tep_href_link(FILENAME_TICKET_VIEW, 'tID=' . $_GET['tID'] . '&page=' . $_GET['page']) . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a> <a href="' . tep_href_link(FILENAME_TICKET_VIEW) . '">' . tep_image_button('button_view_all_tickets.gif', IMAGE_CANCEL) . '</a>'; ?></td>
          </tr>  
          <?php     
            while ($ticket_status = tep_db_fetch_array($ticket_status_query)) {
          ?>
