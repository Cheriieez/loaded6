                                  ...
                                  <tr align="left">
                                    <td>
                                      <div <?php echo 'id="mainnavtabbed' . $i . '"'; ?> class="domtab">
                                        <ul class="domtabs">
                                          <li style="border-left:1px solid #cccccc; border-top:1px solid #cccccc; border-right:1px solid #cccccc;"><a href="#t1<?php echo $i; ?>"><?php echo tep_not_null( TEXT_PRODUCTS_TAB_DESCRIPTION ) ? TEXT_PRODUCTS_TAB_DESCRIPTION : TEXT_PRODUCTS_TAB_DESCRIPTION_DEFAULT; ?></a></li>
                                      ...
                                      <div class="tabcontent">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" summary="description tabe">
                                          ...
                                          <tr align="left">
                                            <td valign="top" class="main"><?php echo (isset($products_description[$languages[$i]['id']]) ? $products_description[$languages[$i]['id']] : tep_get_products_description($pInfo->products_id, $languages[$i]['id'])); ?></td>
                                          </tr>
                                        </table>
                                      </div>
                                      <!-- Tab 2 -->
                                      <div class="tabcontent">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" summary="description tabe">
                                          ...
                                          <tr align="left"> 
                                            <td valign="top" class="main"><?php echo (isset($products_tab_2[$languages[$i]['id']]) ? $products_tab_2[$languages[$i]['id']] : tep_get_products_tab_2($pInfo->products_id, $languages[$i]['id'])); ?></td>
                                          </tr>
                                        </table>
                                      </div>
                                      <!-- Tab 3 -->
                                      <div class="tabcontent">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" summary="description tabe">
                                          ...
                                          <tr align="left">
                                            <td valign="top" class="main"><?php echo (isset($products_tab_3[$languages[$i]['id']]) ? $products_tab_3[$languages[$i]['id']] : tep_get_products_tab_3($pInfo->products_id, $languages[$i]['id'])); ?></td>
                                          </tr>
                                        </table>
                                      </div>
                                      <!-- Tab 4 -->
                                      <div class="tabcontent">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" summary="description tabe">
                                          ...
                                          <tr align="left">
                                            <td valign="top" class="main"><?php echo (isset($products_tab_4[$languages[$i]['id']]) ? $products_tab_4[$languages[$i]['id']] : tep_get_products_tab_4($pInfo->products_id, $languages[$i]['id'])); ?></td>
                                          </tr>
                                        </table>
                                      </div>
                                    </td>
