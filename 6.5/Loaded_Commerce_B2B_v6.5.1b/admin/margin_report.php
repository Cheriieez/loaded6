...
?>
        <td align="right"><table><tr><td><?php echo tep_draw_form('export_to_file', FILENAME_MARGIN_REPORT, 'get', '') . tep_draw_hidden_field('action', 'export') . $get_vars . tep_draw_hidden_field('sql', $listing_sql); ?><input type="text" name="file" value="example_filename" onfocus="javascript:if(this.value=='example_filename') {this.value='';}" onblur="javascript:if(this.value=='') {this.value='example_filename'}"></td><td><?php echo tep_image_submit(DIR_WS_IMAGES . 'export.png', TEXT_EXPORT_BUTTON) . '</form>'; ?></td></tr></table></td>
		  </tr>
        </table>
		</td>
      </tr>
