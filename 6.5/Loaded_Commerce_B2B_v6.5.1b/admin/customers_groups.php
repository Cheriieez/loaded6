            ...
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0" class="data-table">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent" style="line-height: 16px; vertical-align: middle;">
                  ...
                  <a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=group'); ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . TABLE_HEADING_NAME . ' --> A-B-C From Top '); ?></a><a href="<?php echo tep_href_link(basename($PHP_SELF), 'listing=group-desc'); ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . TABLE_HEADING_NAME . ' --> Z-X-Y From Top '); ?></a>
                </td>
