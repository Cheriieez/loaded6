  ...
  switch ($action) {
    case 'save':
      while (list($key, $value) = each($_POST['configuration'])) {
        ...
        tep_db_query("update " . TABLE_CONFIGURATION . " set configuration_value = '" . mysql_escape_string($value) . "' where configuration_key = '" . $key . "'");
      }
            ...
            switch ($action) {
              ...
              default:
                ...
                if ($mInfo->status == '1') {
                  ...
                  if($_GET['module'] == 'datafeed' && !is_dir(DIR_FS_CATALOG . 'feeds/')) {
                    $contents[] = array('text' => '<br> <font color = "red">"feeds/" folder not exists!, Please create that folder by logging into FTP</font> <br>');
                  }
