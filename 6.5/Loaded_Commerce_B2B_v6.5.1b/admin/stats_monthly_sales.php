...
(tep_db_prepare_input($print=='yes')) ? $print=true : $print=false;
// set inversion toggle
(tep_db_prepare_input($invert=='yes')) ? $invert=true : $invert=false;
?>
<!-- header //-->
...
-->
      <tr>
        ...
        if ($sel_month<>0)   {
        echo "<a href='" . tep_href_link(basename($PHP_SELF),'selected_box=reports') . "";
        ...
        <td class="smallText"><a href="<?php echo tep_href_link(basename($PHP_SELF), $_SERVER['QUERY_STRING']."&print=yes");
        ?>" target="print" title="<?php echo TEXT_BUTTON_REPORT_PRINT_DESC . "\">" . TEXT_BUTTON_REPORT_PRINT; ?></a>
        </td>
        <td class="smallText"><a href='<?php echo tep_href_link(basename($PHP_SELF), preg_replace('/&invert=yes/', '', $_SERVER['QUERY_STRING']));
        ...
        echo tep_href_link(basename($PHP_SELF), 'help=yes'); ?>','help',config='height=400,width=600,scrollbars=1, resizable=1')" title="<?php echo TEXT_BUTTON_REPORT_HELP_DESC . "\">" . TEXT_BUTTON_REPORT_HELP; ?></a>
        </td>
        </tr></table>
        </td>
      </tr>
...
<tr>
        <td class="smallText" colspan="4">
          ...
          ?>'><?php echo tep_image_submit('submit.png', TEXT_BUTTON_REPORT_SAVE) ?></form>
              </td>
            </tr>
          </table>
        </td>
