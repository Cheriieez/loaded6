...
*/
  ...
  if (MODULE_ADDONS_ULTIMATESEO_STATUS == 'True') {
    ...
    if (eregi("(save|insert_form|save_form|save_system_form|save_categories|insert_categories|delete_categories_confirm|move_categories_confirm|delete_form_confirm|move_form_confirm|copy_to_form_confirm)", $action)) include_once('includes/reset_seo_cache.php');
  }
