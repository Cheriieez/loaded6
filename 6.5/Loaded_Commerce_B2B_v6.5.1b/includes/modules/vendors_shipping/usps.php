    ...
    if ($order->delivery['country']['iso_code_2'] == 'US') {
      ...
      foreach(explode(', ', @constant('MODULE_SHIPPING_USPS_TYPES_' . $vendors_id)) as $request_type) {
        ...
        if (preg_match('#First\-Class#', $request_type)) {
          ...
          $service = 'MEDIA';
        } elseif ($request_type == 'Parcel PostRM') {
          $service = 'PARCEL';
