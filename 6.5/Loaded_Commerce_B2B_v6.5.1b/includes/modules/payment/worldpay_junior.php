...
*/
  ...
  class worldpay_junior {
    ...
    function worldpay_junior() {
      ...
      $this->title = (defined('MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_TITLE')) ? MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_TITLE : '';
      $this->subtitle = (defined('MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_SUBTITLE')) ? MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_SUBTITLE : '';
      $this->public_title = (defined('MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_PUBLIC_TITLE')) ? MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_PUBLIC_TITLE : '';
      $this->description = (defined('MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_DESCRIPTION')) ? MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_DESCRIPTION : '';
      ...
      $this->form_action_url = (defined('MODULE_PAYMENT_WORLDPAY_JUNIOR_TESTMODE') && MODULE_PAYMENT_WORLDPAY_JUNIOR_TESTMODE == 'True') ? 'https://select-test.worldpay.com/wcc/dispatcher' : 'https://select.worldpay.com/wcc/purchase';
      $this->pci = TRUE;
    }
    ...
    function update_status() {
      ...
      if ( ($this->enabled == true) && ((int)MODULE_PAYMENT_WORLDPAY_JUNIOR_ZONE > 0) ) {
        $check_flag = false;
        $check_query = tep_db_query("select zone_id from " . TABLE_ZONES_TO_GEO_ZONES . " where geo_zone_id = '" . MODULE_PAYMENT_WORLDPAY_JUNIOR_ZONE . "' and ( zone_country_id = 0 or zone_country_id = '" . $order->billing['country']['id'] . "' ) order by zone_id");
    ...
    function selection() {
      ...
      if (isset($_SESSION['cart_Worldpay_Junior_ID'])) {
        $cart_Worldpay_Junior_ID = $_SESSION['cart_Worldpay_Junior_ID'];
    ...
    function confirmation() {
      ...
      if ($insert_order == true) {
        ...
        $sql_data_array = array('customers_id' => $customer_id,
                                ...
                                'date_purchased' => 'now()',
                                'orders_status' => MODULE_PAYMENT_WORLDPAY_JUNIOR_PREPARE_ORDER_STATUS_ID,
        ...
        $_SESSION['cart_Worldpay_Junior_ID'] = $cart_Worldpay_Junior_ID;
      }
    ...
    function process_button() {
      ...
      $process_button_string = tep_draw_hidden_field('instId', MODULE_PAYMENT_WORLDPAY_JUNIOR_INSTALLATION_ID) .
                               ...
                               tep_draw_hidden_field('MC_callback', substr(tep_href_link('wpcallback.php', '', 'NONSSL', false, false), strpos(tep_href_link('wpcallback.php', '', 'NONSSL', false, false), '://')+3));
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable WorldPay Select Junior', 'MODULE_PAYMENT_WORLDPAY_JUNIOR_STATUS', 'True', 'Do you want to accept WorldPay Select Junior payments?', '6', '0', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('MD5 Transaction Password', 'MODULE_PAYMENT_WORLDPAY_JUNIOR_MD5_PASSWORD', '', 'The MD5 secret encryption password used to validate transaction responses with (specified in the WorldPay Customer Management System)', '6', '0', now())");
