...
?>
            <td valign="top" class="main" width="25%" nowrap="nowrap"><?php echo TEXT_TOPIC . '&nbsp;' . $articles_expected['topics_name']; ?></td>
<?php
      }
?>
          </tr>
