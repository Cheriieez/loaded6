...
class PriceFormatter {
  ...
  function loadProduct($product_id, $language_id=1) {
    ...
    $sql="select pd.products_name, p.vendors_id, p.products_model, p.products_image, p.products_id," .
        " p.manufacturers_id, p.products_price, p.products_cost, p.products_msrp, p.products_weight," .
        ...
        " left join " . TABLE_SPECIALS . " s on(s.products_id = p.products_id and s.customers_group_id = " . (int)$customer_group_id . "), " .
        ...
        if($this->hasQuantityPrice == true) {
          if($this->hasCustomersGroupPrice=='true')  {
            if ($this->customers_group_lowPrice != $this->customers_group_hiPrice && $this->customers_group_lowPrice != 0) {
              if ($this->msrp == 0) {
                ...
                if ($this->msrp > $this->customers_group_lowPrice) {
                  $lc_text = TEXT_PRODUCTS_MSRP . $currencies->display_price($this->msrp, tep_get_tax_rate($this->taxClass)) . '<br />' . TEXT_PRODUCTS_OUR_PRICE . $currencies->display_price($this->customers_group_lowPrice, tep_get_tax_rate($this->taxClass)) . ' - ' . $currencies->display_price($this->customers_group_hiPrice, tep_get_tax_rate($this->taxClass)) . '<br />Savings:&nbsp;' . $currencies->display_price($this->msrp - $this->customers_group_hiPrice, tep_get_tax_rate($this->taxClass)) . '&nbsp;('. number_format(100 - (($this->customers_group_hiPrice / $this->msrp) * 100)) . '%)';
                } else {
                  $lc_text = TEXT_PRODUCTS_MSRP . $currencies->display_price($this->msrp, tep_get_tax_rate($this->taxClass)) . '<br />' . TEXT_PRODUCTS_OUR_PRICE . $currencies->display_price($this->customers_group_lowPrice, tep_get_tax_rate($this->taxClass)) . ' - ' . $currencies->display_price($this->customers_group_hiPrice, tep_get_tax_rate($this->taxClass)) . '&nbsp;';
                }
              }
            } else {
              if ($this->msrp == 0) {
                ...
                if ($this->msrp > $this->customers_group_lowPrice) {
                  $lc_text = TEXT_PRODUCTS_MSRP . $currencies->display_price($this->msrp, tep_get_tax_rate($this->taxClass)) . '<br />' . TEXT_PRODUCTS_OUR_PRICE . $currencies->display_price($this->customers_group_lowPrice, tep_get_tax_rate($this->taxClass)) . '<br />Savings:&nbsp;' . $currencies->display_price($this->msrp - $this->customers_group_lowPrice, tep_get_tax_rate($this->taxClass)) . '&nbsp;('. number_format(100 - (($this->customers_group_lowPrice / $this->msrp) * 100)) . '%)';
                } else {
                  $lc_text = TEXT_PRODUCTS_MSRP . $currencies->display_price($this->msrp, tep_get_tax_rate($this->taxClass)) . '<br />' . TEXT_PRODUCTS_OUR_PRICE . $currencies->display_price($this->customers_group_lowPrice, tep_get_tax_rate($this->taxClass)) . '&nbsp;';
                }
              }
            }
          } else {
          ...
          if($this->hasCustomersGroupPrice=='true')  {
            if ($this->msrp == 0) {
              ...
              if ($this->msrp > $this->customers_group_thePrice) {
                $lc_text = TEXT_PRODUCTS_MSRP . $currencies->display_price($this->msrp, tep_get_tax_rate($this->taxClass)) . '<br />' . TEXT_PRODUCTS_OUR_PRICE . $currencies->display_price($this->customers_group_thePrice, tep_get_tax_rate($this->taxClass)) . '<br />Savings:&nbsp;' . $currencies->display_price($this->msrp - $this->customers_group_thePrice, tep_get_tax_rate($this->taxClass)) . '&nbsp;('. number_format(100 - (($this->customers_group_thePrice / $this->msrp) * 100)) . '%)';
              } else {
                $lc_text = TEXT_PRODUCTS_MSRP . $currencies->display_price($this->msrp, tep_get_tax_rate($this->taxClass)) . '<br />' . TEXT_PRODUCTS_OUR_PRICE . $currencies->display_price($this->customers_group_thePrice, tep_get_tax_rate($this->taxClass)) . '&nbsp;';
              }
            }
          } else {
            if ($this->msrp == 0) {
              ...
              if ($this->msrp > $this->thePrice) {
                $lc_text = TEXT_PRODUCTS_MSRP . $currencies->display_price($this->msrp, tep_get_tax_rate($this->taxClass)) . '<br />' . TEXT_PRODUCTS_OUR_PRICE . $currencies->display_price($this->thePrice, tep_get_tax_rate($this->taxClass)) . '<br />Savings:&nbsp;' . $currencies->display_price($this->msrp - $this->thePrice, tep_get_tax_rate($this->taxClass)) . '&nbsp;('. number_format(100 - (($this->thePrice / $this->msrp) * 100)) . '%)';
              } else {
  ...
  function hasCustomerGroupcomputePrice($qty) {
    ...
    for ($i=1; $i<=11; $i++)
      ...
      if ($this->hasCustomersGroupPrice == 'true') {
        ...
        for ($i=1; $i<=11; $i++) {
          if (($this->customers_group_price[$i] > 0) && ($this->quantity[$i] > 0) && ((($qty > $this->quantity[$i]) && ($i != 1)) || (($qty >= $this->quantity[$i]) && ($i == 1)))) {
