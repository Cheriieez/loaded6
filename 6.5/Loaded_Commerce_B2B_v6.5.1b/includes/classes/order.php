...
//end PayPal_Shopping_Cart_IPN
      ...
      // Begin RMA Returns System mod
      $orders_products_query = tep_db_query("select orders_products_id, products_id, products_name, products_model, products_price, products_cost, products_returned, products_exchanged, products_exchanged_id, products_tax, products_quantity, final_price from " . TABLE_ORDERS_PRODUCTS . " where orders_id = '" . tep_db_input($order_id) . "'");
      // End RMA Returns System mod
      ...
      while ($orders_products = tep_db_fetch_array($orders_products_query)) {
        ...
        $subindex = 0;
        $attributes_query = tep_db_query("select products_options_id, products_options, products_options_values_id, products_options_values, options_values_price, price_prefix from " . TABLE_ORDERS_PRODUCTS_ATTRIBUTES . " where orders_id = '" . (int)$order_id . "' and orders_products_id = '" . (int)$products_id_tmp . "'");
    ...
    function cart() {
      ...
      $this->info = array('order_status' => DEFAULT_ORDERS_STATUS_ID,
                          ...
                          //MVS Start
                          'shipping_tax' => $_SESSION['shipping']['shipping_tax_total'],
                          'subtotal' => 0,
                          'tax' => 0 + $_SESSION['shipping']['shipping_tax_total'],
                          //MVS End
                          'subtotal' => 0,
                          'tax' => 0,
                          'tax_groups' => array(),
