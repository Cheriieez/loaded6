...
define('TEXT_ENTER_PAYMENT_INFORMATION', 'Please select a payment method.');
...
define('TEXT_ORDER_TOTAL_ZERO','Congratulations! Your Order Total is Zero, please select confirm order to continue.');
?>
