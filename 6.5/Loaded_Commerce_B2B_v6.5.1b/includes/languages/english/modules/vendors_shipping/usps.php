...
define('MODULE_SHIPPING_USPS_TEXT_DESCRIPTION', 'United States Postal Service v4.2.0.M for Loaded Commerce (MVS Version)<br /><br />You will need to <a href="https://secure.shippingapis.com/registration/" target="_blank">Register an Account with USPS</a> to use this module<br /><br />USPS expects you to use pounds as weight measure for your products.');
