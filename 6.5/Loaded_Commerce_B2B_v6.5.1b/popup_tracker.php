...
<body onload=pageSubmit();>
    ...
    if (eregi('USPS',$type)) /* for usps shipping */ { ?>
	...
	<?php } else if (eregi('UPS',$type)) /* for ups shipping */ { ?>
	...
	<?php } else if (eregi('Fedex',$type)) /* for fedex shipping */ { ?>
	...
	<?php } else if (eregi('Xpresspost',$type)) /* for canada post shipping */ { ?>
	...
	<?php } else if (eregi('Airmail',$type)) /* for canada airmail post shipping */ { ?>
		<FORM NAME="tracking" ACTION="https://em.canadapost.ca/emo/basicPin.do?" TARGET="new" METHOD="POST">
			<INPUT TYPE="hidden" NAME="trackingCode" VALUE="PIN">
			<INPUT TYPE="hidden" NAME="action" VALUE="query">
			<INPUT TYPE="hidden" NAME="trackingId" VALUE="<?php echo $tracknumbers ?>">
		</FORM>
	<?php } else if (eregi('Danmark',$type)) /* for post danmark shipping */ { ?>
	...
	<?php } else if (eregi('Zealand',$type)) /* for new zealand post shipping */ { ?>
