          ...
          <tr class="infoBoxContents">
            <td><table border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('company_tax_id', $account['entry_company_tax_id']) . '&nbsp;' . (tep_not_null(ENTRY_COMPANY_TAX_ID_TEXT) ? '<span class="inputRequirement">' . ENTRY_COMPANY_TAX_ID_TEXT . '</span>': ''); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
