...
<?php
echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL'), 'post', 'class="form-horizontal" onSubmit="return check_form_optional(checkout_address);"'); ?>
<h1 class="col-sm-12 gry_box2 y_clr con_txt"><?php echo TABLE_HEADING_SHIPPING_ADDRESS; ?></h1>
...
?>
	<div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><?php echo TABLE_HEADING_SHIPPING_ADDRESS; ?></h3>
      </div>
    ...
    <table class="table cart-tbl">
        <thead>
            <tr>
                <th><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES.'<br>'.TEXT_SELECT_OTHER_SHIPPING_DESTINATION;?></th>
...
?>        
                    ...
                    <td class="col-sm-1 col-md-1 text-right"><?php echo tep_draw_radio_field('address', $addresses['address_book_id'], ($addresses['address_book_id'] == $_SESSION['sendto'])); ?></td>
                   </tr>
...
<div class="stepwizard">
            <div class="stepwizard-row">
                <div class="stepwizard-step">
                    <?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '" class="btn btn-primary btn-circle">1</a>'; ?>
