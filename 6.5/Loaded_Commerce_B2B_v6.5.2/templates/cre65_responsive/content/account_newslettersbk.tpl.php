  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
		<div class="col-sm-1 moduleRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="checkBox('newsletter_general')"><?php echo tep_draw_checkbox_field('newsletter_general', '1', (($newsletter['customers_newsletter'] == '1') ? true : false), 'onclick="checkBox(\'newsletter_general\')"'); ?></div>
      ...
      // RCI code eof   
      ?>
     <div class="col-sm-6"><?php echo '<a class="btn btn-primary" href="' . tep_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">' . tep_template_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></div><div class="col-sm-6"><button class="btn btn-danger pull-right">Continue</button></div>
</form>
    <?php
    // RCI code start
