...
<?php if ( (ALLOW_CATEGORY_DESCRIPTIONS == 'true') && (isset($category) && tep_not_null($category['categories_description'])) ) {  echo '<div class="col-lg-12"><span class="category_desc">' . $category['categories_description'] . '</span></div>'; } ?>
<?php
  ...
  if (PRODUCT_LIST_FILTER > 0) {
    ...
    if (tep_db_num_rows($filterlist_query) > 1) {
      ...
      echo tep_draw_form('filter', FILENAME_DEFAULT, 'get', 'class="form-inline pull-right"');
      echo '<div class="form-group"><label for"filter_id">' . TEXT_SHOW . '&nbsp;&nbsp;</label>';
      if (isset($_GET['manufacturers_id'])) {
      ...
      echo tep_draw_pull_down_menu('filter_id', $options, (isset($_GET['filter_id']) ? $_GET['filter_id'] : ''), 'onchange="this.form.submit();" class="form-control margin-top-15 margin-bottom-15"');
      echo '</div></form></div><div class="clearfix"></div>' . "\n";
    }
  }
