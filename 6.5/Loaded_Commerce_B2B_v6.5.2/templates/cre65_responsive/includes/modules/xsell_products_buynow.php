...
<?php
	  ...
	  if($col == 0){$active=' active';}else{$active='';}
	  echo '<div class="item'.$active.'"><div class="col-sm-6 col-xs-6 pad-right-8 mbot15">'.$img.'</div><div class="col-sm-6 col-xs-6 pad-left-8 mbot15"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $xsell['products_id']) . '">' . $xsell['products_name'] .'</a><p><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $xsell['products_id']) . '"><b>$' . number_format($xsell['products_price'],2) .'</b></a></p></div><div class="clearfix"></div></div>';
