...
<?php
    if ($error == true) {
      ...
      echo tep_draw_input_field('entry_company_tax_id', (isset($cInfo->entry_company_tax_id) ? $cInfo->entry_company_tax_id : ''), 'maxlength="32"');
      }
?></td>
          </tr>
...
<tr>
  ...
  if(ACCOUNT_EMAIL_CONFIRMATION=='true')  { 
    echo tep_draw_pull_down_menu('customers_emailvalidated', $emailvalidated_array, (isset($cInfo->customers_validation) ? $cInfo->customers_validation : ''));
     ...
     echo tep_draw_pull_down_menu('customers_emailvalidated', $emailvalidated_array, (isset($cInfo->customers_validation) ? $cInfo->customers_validation : '')) . '&nbsp; <span class="fieldRequired">' . TEXT_EMAIL_VALIDATE_FEATURE . '</span>';
  }
  ?>   
  </td>
</tr>  
  ...
  if(B2B_REQUIRE_ACCOUNT_APPROVAL=='Requires Approval') {  
    ...
    echo  tep_draw_pull_down_menu('customers_accountvalidated',$accountvalidated_array, $cInfo->customers_account_approval) . ' &nbsp; <span class="fieldRequired">' . TEXT_ACCOUNT_VALIDATE_FEATURE . '</span>';
  }
  ?>   
...
?>
                <td class="dataTableHeadingContent" valign="top"><a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=company'); ?>"><img src="images/arrow_up.gif" border="0"></a>&nbsp;<a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=company-desc'); ?>"><img src="images/arrow_down.gif" border="0"></a><br><?php echo TABLE_HEADING_COMPANY; ?></td>
                ...
                <td class="dataTableHeadingContent" valign="top"><a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=cg_name'); ?>"><img src="images/arrow_up.gif" border="0"></a>&nbsp;<a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=cg_name-desc'); ?>"><img src="images/arrow_down.gif" border="0"></a><br><?php echo TABLE_HEADING_CUSTOMERS_GROUPS; ?></td>
                <td class="dataTableHeadingContent" align="right" valign="top"><a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=id-asc'); ?>"><img src="images/arrow_up.gif" border="0"></a>&nbsp;<a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=id-desc'); ?>"><img src="images/arrow_down.gif" border="0"></a><br><?php echo TABLE_HEADING_ACCOUNT_CREATED; ?></td>
                <td class="dataTableHeadingContent" align="middle" valign="top"><a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=ra'); ?>"><img src="images/arrow_up.gif" border="0"></a>&nbsp;<a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=ra-desc'); ?>"><img src="images/arrow_down.gif" border="0"></a><br><?php echo TABLE_HEADING_REQUEST_AUTHENTICATION; ?>&nbsp;</td>
...
<?php
      if ($customers['customers_group_ra'] == '1') {
        echo tep_image(DIR_WS_IMAGES . 'cancel.png', IMAGE_ICON_STATUS_GREEN, 16, 16);
        } else {
...
// EOF Separate Pricing Per Customer
    ...
    default:
      if (isset($cInfo) && is_object($cInfo)) {
        ...
        $contents[] = array('align' => 'center',
                            'text' => '<a href="' . tep_href_link(FILENAME_CREATE_ORDER, 'Customer=' . $cInfo->customers_id) . '">' . tep_image_button('button_create_order.gif', IMAGE_BUTTON_CREATE_ORDER) . '</a><br>'
                            );
        if (ACCOUNT_EMAIL_CONFIRMATION == 'true') {
          $contents[] = array('align' => 'center',
