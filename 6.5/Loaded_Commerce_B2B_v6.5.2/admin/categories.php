...
if (tep_not_null($action)) {
  switch ($action) {
    ...
    case 'update_product':
      ...
      if ((defined('MODULE_ADDONS_TABS_STATUS') && MODULE_ADDONS_TABS_STATUS == 'True') && (defined('PRODUCT_INFO_TAB_ENABLE') && PRODUCT_INFO_TAB_ENABLE == 'True') ) {
        $product_tabs_columns = 'products_tab_2, products_tab_3, products_tab_4, ';
      }
      $products_description_old_query = tep_db_query("SELECT language_id, products_name, products_blurb, products_description, " . $product_tabs_columns . " products_url, products_viewed, 
      ...
      while ($description_old = tep_db_fetch_array($products_description_old_query)) {
        ...
        if ((defined('MODULE_ADDONS_TABS_STATUS') && MODULE_ADDONS_TABS_STATUS == 'True') && (defined('PRODUCT_INFO_TAB_ENABLE') && PRODUCT_INFO_TAB_ENABLE == 'True') ) {
            $products_description_old[$description_old['language_id']]['products_tab_2'] = $description_old['products_tab_2'];
            $products_description_old[$description_old['language_id']]['products_tab_3'] = $description_old['products_tab_3'];
            $products_description_old[$description_old['language_id']]['products_tab_4'] = $description_old['products_tab_4'];
        }
      }
      ...
      if ($products_msrp != $products_old['products_msrp']) $sql_data_array['products_msrp'] = $products_msrp;
      ...
      if ($isSubProduct) {
        ...
        for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
          $language_id = $languages[$i]['id'];
          $products_name_input = tep_db_prepare_input(tep_db_encoder(str_replace(" - ", " ", $_POST['products_name'][$language_id])));
        ...
        for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
          $language_id = $languages[$i]['id'];
          $products_description_parent[$language_id] = array('products_name' => tep_db_prepare_input(tep_db_encoder(str_replace(" - ", " ", $_POST['products_name'][$language_id]))),
                                                             'products_blurb' => tep_db_prepare_input(tep_db_encoder($_POST['products_blurb'][$language_id])), 
                                                             'products_description' => tep_db_prepare_input(tep_db_encoder($_POST['products_description'][$language_id]))
                                                             );
        if ((defined('MODULE_ADDONS_TABS_STATUS') && MODULE_ADDONS_TABS_STATUS == 'True') && (defined('PRODUCT_INFO_TAB_ENABLE') && PRODUCT_INFO_TAB_ENABLE == 'True') ) {
             $products_description_parent[$language_id]['products_tab_2'] = tep_db_prepare_input(tep_db_encoder($_POST['products_tab_2'][$language_id]));
             $products_description_parent[$language_id]['products_tab_3'] = tep_db_prepare_input(tep_db_encoder($_POST['products_tab_3'][$language_id]));
             $products_description_parent[$language_id]['products_tab_4'] = tep_db_prepare_input(tep_db_encoder($_POST['products_tab_4'][$language_id]));
        }
        
          if (!isset($products_description_old[$language_id])) {
            $_POST['products_url'][$language_id] = urldecode($_POST['products_url'][$language_id]);
            if (substr($_POST['products_url'][$language_id], 0, 7) == 'http://') $_POST['products_url'][$language_id] = substr($_POST['products_url'][$language_id], 7);
            $sql_data_array = array('products_name' => tep_db_prepare_input(tep_db_encoder(str_replace(" - ", " ", $_POST['products_name'][$language_id]))),
                                    'products_blurb' => tep_db_prepare_input(tep_db_encoder($_POST['products_blurb'][$language_id])),
                                    'products_description' => tep_db_prepare_input(tep_db_encoder($_POST['products_description'][$language_id])),
                                    'products_url' => tep_db_prepare_input($_POST['products_url'][$language_id]),
                                    'products_head_title_tag' => tep_db_prepare_input(tep_db_encoder($_POST['products_head_title_tag'][$language_id])),
        ...
        if ((defined('MODULE_ADDONS_TABS_STATUS') && MODULE_ADDONS_TABS_STATUS == 'True') && (defined('PRODUCT_INFO_TAB_ENABLE') && PRODUCT_INFO_TAB_ENABLE == 'True') ) {
             $sql_data_array['products_tab_2'] = tep_db_prepare_input(tep_db_encoder($_POST['products_tab_2'][$language_id]));
             $sql_data_array['products_tab_3'] = tep_db_prepare_input(tep_db_encoder($_POST['products_tab_3'][$language_id]));
             $sql_data_array['products_tab_4'] = tep_db_prepare_input(tep_db_encoder($_POST['products_tab_4'][$language_id]));
        }
          } else {
            $sql_data_array = array(); //declare the array and add to it anything changed
            $products_name = tep_db_prepare_input(tep_db_encoder(str_replace(" - ", " ", $_POST['products_name'][$language_id])));
            if ($products_description_old[$language_id]['products_name'] != $products_name) {
            ...
            if ($products_description_old[$language_id]['products_description'] != $products_description) $sql_data_array['products_description'] = tep_db_encoder($products_description);
            if ((defined('MODULE_ADDONS_TABS_STATUS') && MODULE_ADDONS_TABS_STATUS == 'True') && (defined('PRODUCT_INFO_TAB_ENABLE') && PRODUCT_INFO_TAB_ENABLE == 'True') ) {
                $products_tab_2 = tep_db_prepare_input(tep_db_encoder($_POST['products_tab_2'][$language_id]));
                if ($products_description_old[$language_id]['products_tab_2'] != $products_tab_2) $sql_data_array['products_tab_2'] = tep_db_encoder($products_tab_2);
                $products_tab_3 = tep_db_prepare_input(tep_db_encoder($_POST['products_tab_3'][$language_id]));
                if ($products_description_old[$language_id]['products_tab_3'] != $products_tab_3) $sql_data_array['products_tab_3'] = tep_db_encoder($products_tab_3);
                $products_tab_4 = tep_db_prepare_input(tep_db_encoder($_POST['products_tab_4'][$language_id]));
                if ($products_description_old[$language_id]['products_tab_4'] != $products_tab_4) $sql_data_array['products_tab_4'] = tep_db_encoder($products_tab_4);
            }
            $_POST['products_url'][$language_id] = urldecode($_POST['products_url'][$language_id]);
            if (substr($_POST['products_url'][$language_id], 0, 7) == 'http://') $_POST['products_url'][$language_id] = substr($_POST['products_url'][$language_id], 7);
            $products_url = tep_db_prepare_input($_POST['products_url'][$language_id]);
    ...
    case 'copy_to_confirm':
      if (isset($_POST['products_id']) && isset($_POST['categories_id'])) {
        ...
        if ($_POST['copy_as'] == 'link') {
          ...
          $description_query = tep_db_query("select language_id, products_name, products_blurb, products_description, " . $product_tabs_columns . " products_head_title_tag, products_head_desc_tag, products_head_keywords_tag, products_url from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$products_id . "'");
          while ($description = tep_db_fetch_array($description_query)) {
            if ((defined('MODULE_ADDONS_TABS_STATUS') && MODULE_ADDONS_TABS_STATUS == 'True') && (defined('PRODUCT_INFO_TAB_ENABLE') && PRODUCT_INFO_TAB_ENABLE == 'True') ) { 
              tep_db_query("insert into " . TABLE_PRODUCTS_DESCRIPTION . " (products_id, language_id, products_name, products_blurb, products_description, " . $product_tabs_columns . " products_head_title_tag, products_head_desc_tag, products_head_keywords_tag, products_url, products_viewed) values ('" . (int)$dup_products_id . "', '" . (int)$description['language_id'] . "', '" . tep_db_input($description['products_name']) . "', '" . tep_db_input($description['products_blurb']) . "', '" . tep_db_input($description['products_description']) . "', '" . tep_db_input($description['products_tab_2']) . "', '" . tep_db_input($description['products_tab_3']) . "', '" . tep_db_input($description['products_tab_4']) . "', '" . tep_db_input($description['products_head_title_tag']) . "', '" . tep_db_input($description['products_head_desc_tag']) . "', '" . tep_db_input($description['products_head_keywords_tag']) . "', '" . tep_db_input($description['products_url']) . "', '0')");
            } else {
  ...
  <tr>
    ...
    <td class="page-container" valign="top">
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        if (defined('IMAGE_DROPDOWN_PRELOAD') && IMAGE_DROPDOWN_PRELOAD != 'no') {
        ...
        if ( isset($action) && ($action == 'new_category' || $action == 'edit_category') ) {
                  ...
                  <tr valign="top">
                    ...
                    <td width="33%" class="main">
                      <div class="tab-pane" id="imgTabPane1">
                        ...
                        <?php if (defined('IMAGE_DROPDOWN_PRELOAD') && IMAGE_DROPDOWN_PRELOAD != 'no') { ?>
          ...
          if (isset($pID) && empty($_POST)) {
            ...
            $products_name = str_replace(" - ", " ", $_POST['products_name']);
        ...
        for ($i=0; $i<sizeof($languages); $i++) {
          ...
          if ((defined('MODULE_ADDONS_TABS_STATUS') && MODULE_ADDONS_TABS_STATUS == 'True') && (defined('PRODUCT_INFO_TAB_ENABLE') && PRODUCT_INFO_TAB_ENABLE == 'True') ) {
              $products_elements .= 'products_tab_2[' . $languages[$i]['id'] . '],';
              $products_elements .= 'products_tab_3[' . $languages[$i]['id'] . '],';
              $products_elements .= 'products_tab_4[' . $languages[$i]['id'] . '],';
          }
        }
                    ...
                    <td width="50%"><table  border="0" cellspacing="2" cellpadding="2">
                      <tr>
                        ...
                        if ($parentid["products_parent_id"] == 0) {
                         ...
                         ?>
                         <td class="main"><?php echo tep_draw_hidden_field('products_status',$pInfo->products_status).TEXT_SUB_PRODUCT_SUBPRODUCT; ?></td>  <?php
                        }
                        ?>
                      </tr>
                      <tr>
...
?>
                ...
                <table width="100%"  border="0" cellspacing="2" cellpadding="2">
                  ...
                  <tr bgcolor="#ebebff">
                    ...
                    <td class="main"><?php echo '&nbsp;' . tep_draw_input_field('products_cost', $pInfo->products_cost, ''); ?></td>
                  </tr>
                  <tr bgcolor="#ebebff">
                    <td class="main"><?php echo TEXT_PRODUCTS_PRICE_MSRP; ?></td>
                    <td class="main"><?php echo '&nbsp;' . tep_draw_input_field('products_msrp', $pInfo->products_msrp); ?></td>
                  </tr>
                  <tr bgcolor="#ebebff">
...
//                            }
                  ...
                  <table border="0" cellpadding="2" cellspacing="2" width="100%">
                    ...
                    <tr>
                      <td class="dataTableRow" valign="top">
                        ...
                        <br><br>
                        <div class="tab-pane" id="imgTabPane2">
                          <script type="text/javascript">
                            imgTp1 = new WebFXTabPane( document.getElementById( "imgTabPane2" ) );
                          </script>
                          <div class="tab-page" id="new_file">
                            <h2 class="tab"><?php echo TEXT_TAB_PANE_NEW_FILE; ?></h2>
                            <script type="text/javascript">imgTp1.addTabPage( document.getElementById( "new_file" ) );</script>
                    ...
                    <tr>
                      <td class="dataTableRow" valign="top">
                        ...
                        <br><br>
                        <div class="tab-pane" id="imgTabPane3">
                          <script type="text/javascript">
                            imgTp2 = new WebFXTabPane( document.getElementById( "imgTabPane3" ) );
                          </script>
                    ...
                    <tr>
                      <td class="dataTableRow" valign="top">
                        ...
                        <br><br>
                        <div class="tab-pane" id="imgTabPane4">
                          <script type="text/javascript">
                            imgTp3 = new WebFXTabPane( document.getElementById( "imgTabPane4" ) );
                          </script>
        ...
        for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
          if ($read == 'only') {
            ...
            if ((defined('MODULE_ADDONS_TABS_STATUS') && MODULE_ADDONS_TABS_STATUS == 'True') && (defined('PRODUCT_INFO_TAB_ENABLE') && PRODUCT_INFO_TAB_ENABLE == 'True') ) { 
              $pInfo->products_tab_2 = tep_get_products_tab_2($pInfo->products_id, $languages[$i]['id']);
              $pInfo->products_tab_3 = tep_get_products_tab_3($pInfo->products_id, $languages[$i]['id']);
              $pInfo->products_tab_4 = tep_get_products_tab_4($pInfo->products_id, $languages[$i]['id']);
            }
            ...
            if ((defined('MODULE_ADDONS_TABS_STATUS') && MODULE_ADDONS_TABS_STATUS == 'True') && (defined('PRODUCT_INFO_TAB_ENABLE') && PRODUCT_INFO_TAB_ENABLE == 'True') ) { 
              $pInfo->products_tab_2 = tep_db_prepare_input($products_tab_2[$languages[$i]['id']]);
              $pInfo->products_tab_3 = tep_db_prepare_input($products_tab_3[$languages[$i]['id']]);
              $pInfo->products_tab_4 = tep_db_prepare_input($products_tab_4[$languages[$i]['id']]);
            }
...
?>           </td>
            ...
            <tr>
              <td class="main"><?php 
                 if ((defined('MODULE_ADDONS_TABS_STATUS') && MODULE_ADDONS_TABS_STATUS == 'True') && (defined('PRODUCT_INFO_TAB_ENABLE') && PRODUCT_INFO_TAB_ENABLE == 'True') ) {
                    require(DIR_WS_MODULES . 'product_tabs_preview.php');   
                } else {
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    echo tep_draw_form('sort', FILENAME_CATEGORIES, tep_get_all_get_params(array('action')) . 'action=sort', 'post', '', 'SSL');
                      ...
                      if (isset($_POST['search'])) {
                        $search = str_replace("'", "&#39;", tep_db_prepare_input($_POST['search'])); 
                        $products_query = tep_db_query("SELECT p.products_id, pd.products_name, p.products_quantity, p.products_image, p.products_price, p.products_cost, p.products_msrp, p.vendors_product_price, p.vendors_prod_comments, p.products_date_added, p.products_last_modified, p.products_date_available, p.products_status, p.products_model, p2c.categories_id
                ...
                default:
                  if ($rows > 0) {
                    if (isset($cInfo) && is_object($cInfo)) { // category info box contents
                      ...
                      $contents[] = array('text' => '<br>' . TEXT_PRODUCTS_COST_INFO . ' <b>' . $currencies->format($pInfo->products_cost) . '<b>');
                      $contents[] = array('text' => '<br>' . TEXT_PRODUCTS_MSRP_INFO . ' <b>' . $currencies->format($pInfo->products_msrp) . '<b>'); 
