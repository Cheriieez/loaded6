...
*/
  ...
  select count(*) as count, sum(affiliate_value) as total, sum(affiliate_payment) as payment from
    ...
    " . TABLE_ORDERS . " o 
    where a.affiliate_id = '" . $_GET['acID'] . "' and
            ...
            <td><table width="100%" border="0" cellpadding="4" cellspacing="2" class="dataTableContent">
              <center>
                ...
                <tr>
                  ...
                  <td width="35%" align="right" class="dataTableContent"><b><?php echo '<a href="javascript:popupWindow(\'' . tep_href_link(FILENAME_POPUP_AFFILIATE_HELP,'help_text=11') . '\')">' . TEXT_SUMMARY_HELP . '</a>'; ?></b></td>
