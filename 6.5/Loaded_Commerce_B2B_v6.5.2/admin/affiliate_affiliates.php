                      ...
                      <tr>
                        ...
                        <?php
                          ...
                          while ($affiliate = tep_db_fetch_array($affiliate_query)) {
                            ...
                            if (isset($_GET['acID'])) {
                              $tmp_acID = $_GET['acID'];
                                ...
                                $tmp_acID = $aInfo->affiliate_id;
                              }

                              if ( (is_object($aInfo)) && ($tmp_acID == $affiliate['affiliate_id']) ) {
                          ...
                          <td class="dataTableContent" align="right">
                            <?php 
                              if(isset($affiliate['affiliate_commission_percent']) && $affiliate['affiliate_commission_percent'] > 0 ){
                                echo $affiliate['affiliate_commission_percent'];
                              }else if(isset($affiliate['affiliate_commission_percent']) && $affiliate['affiliate_commission_percent'] == 0 ){
                                echo AFFILIATE_PERCENT_DEFAULT_SET;
                              } else {
