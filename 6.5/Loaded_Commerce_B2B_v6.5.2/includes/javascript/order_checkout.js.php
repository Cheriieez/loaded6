...
function handleHttpResponse_order() {
  if (http_order.readyState == 4) {
    ...
    if(document.getElementById("id_customer_shopping_points_spending").checked == false) {
      document.getElementById('div_shopping_points_redemptions').innerHTML = document.getElementById('textinp_id').value;
      document.getElementById('div_shopping_points_redem_price').innerHTML = document.getElementById('textinp_id').value;
      document.getElementById('div_max_redem_points').innerHTML = document.getElementById('max_points_id').value;
      document.getElementById('id_customer_shopping_points_spending').value = document.getElementById('max_points_id').value;
    }

    
    if(document.getElementById('order_info_total_id').value > 0) {      
      document.getElementById("id_div_payment_hide").style.display = "block";         
      document.getElementById("id_div_payment_show").style.display = "none"; 
    } else {       
       document.getElementById("id_div_payment_hide").style.display = "none"; 
       document.getElementById("id_div_payment_show").style.display = "block"; 
    } 
...
function applyRedemption() {  
  shipping = $('input:radio[name=shipping]:checked').val();
  shipping = 'shipping='+shipping;
  customer_points_spending = $('input:checkbox[name=customer_shopping_points_spending]:checked').val();
  customer_points_spending = '&customer_points_spending='+customer_points_spending;
  http_order.open("GET", url_order + '?' + shipping + customer_points_spending, true);
