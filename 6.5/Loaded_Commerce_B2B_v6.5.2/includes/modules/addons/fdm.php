...
*/
  ...
  class fdm {
    ...
    function install() {
      ...
      tep_db_query('INSERT IGNORE INTO configuration VALUES ("", "Replace Spaces in file names", "FDMS_REMOVE_SPACES", "Yes", "If set to true the spaces will be removed from filenames upon upload and replaced with a dash. This is good for linux servers.", 450, 19, now(), now(), NULL, "tep_cfg_select_option(array(""Yes"", ""No""),")');
