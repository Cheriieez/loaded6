...
if(isset($_GET['customer_points_spending'])) {
  $_SESSION['customer_shopping_points_spending'] = $_GET['customer_points_spending'];
}
...
if(function_exists('tep_get_shopping_points')) {
  ...
  echo '<input type = "hidden" id = "max_points_id" name = "max_points_id" value = "'.$tmp_max_points.'">';
}

echo '<table><tr><td class="main">' . $order_total_modules->output() . '</td></tr></table><input type = "hidden" id = "textinp_id" name = "textinp" value = "'.$currencies->format($order->info['total']).'"><input type = "hidden" id = "order_info_total_id" name = "order_info_total" value = "'.$order->info['total'].'">';
?>