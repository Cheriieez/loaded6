          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent" width = '4%' align = 'left'><?php echo TABLE_HEADING_NUMBER; ?></td>
                <td class="dataTableHeadingContent" width = '34%' align = 'left'><?php echo TABLE_HEADING_FILE_NAME; ?></td>
                <td class="dataTableHeadingContent" align="center" width = '7%'><?php echo TABLE_HEADING_FILE_STATUS; ?></td>
                <td class="dataTableHeadingContent" width = '10%' align = 'center'><?php echo TABLE_HEADING_FILE_AVAILABILITY; ?>&nbsp;&nbsp;</td>              
                <td class="dataTableHeadingContent" align="right" width = '4%'><?php echo TABLE_HEADING_PRODUCT_ID; ?>&nbsp;&nbsp;</td>
                <td class="dataTableHeadingContent" width = '34%' align="left"><?php echo TABLE_HEADING_PRODUCT_NAME; ?></td>
                <td class="dataTableHeadingContent" align="center" width = '7%'><?php echo TABLE_HEADING_PURCHASE_REQUIRED; ?></td>
              </tr>
              <?php
              ...
              while ($products_with_files = tep_db_fetch_array($products_with_files_query)) {
                ...
                if ($tmp_id > 0) {
                  if ($tmp_id != $products_with_files['files_id']) {
                    $tmp_id = $products_with_files['files_id'];
                    $i_tmp_id = $tmp_id;
                    $s_tmp_file_name = $products_with_files['files_name'];
                    $tmp_status = $products_with_files['files_status'];
                  } else {
                    $i_tmp_id = '';
                    $s_tmp_file_name = '';
                    $tmp_status = '';
                ...
                <tr <?php echo $s_class;?>>
                  <td class="dataTableContent" align="left"><?php echo $i_tmp_id; ?></td>
                  <td class="dataTableContent" align="left"><?php echo  $s_tmp_file_name; ?></td>
                  ...
                  <td class="dataTableContent" align="right"><?php echo $products_with_files['products_id']; ?>&nbsp;</td>
                  <td class="dataTableContent" align="left"><?php echo $products_with_files['products_name']; ?>&nbsp;</td>    
                  <td class="dataTableContent" align="center">
                    <?php                    
