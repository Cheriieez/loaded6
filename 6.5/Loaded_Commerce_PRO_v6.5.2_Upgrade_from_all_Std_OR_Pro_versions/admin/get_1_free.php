      ...
      <?php if ($form_action == 'update') echo tep_draw_hidden_field('get_1_free_id', $_GET['fID']); ?>
        <td><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <?php
              if ( ($action == 'edit') && isset($_GET['fID']) ) {
                ...
                echo tep_draw_get1free_pull_down('products_id', 'style="font-size:10px"', $get_1_free_array);
              }
            ?>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="main"><?php echo tep_draw_get1free_pull_down('products_free_id', 'style="font-size:10px"'); ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="main"><?php echo tep_draw_input_field('day', (isset($fInfo->get_1_free_expires_date) ? substr($fInfo->get_1_free_expires_date, 8, 2) : ''), 'size="2" maxlength="2" class="cal-TextBox"') . tep_draw_input_field('month', (isset($fInfo->get_1_free_expires_date) ? substr($fInfo->get_1_free_expires_date, 5, 2) : ''), 'size="2" maxlength="2" class="cal-TextBox"') . tep_draw_input_field('year', (isset($fInfo->get_1_free_expires_date) ? substr($fInfo->get_1_free_expires_date, 0, 4) : ''), 'size="4" maxlength="4" class="cal-TextBox"'); ?><a class="so-BtnLink" href="javascript:calClick();return false;" onmouseover="calSwapImg('BTN_date', 'img_Date_OVER',true);" onmouseout="calSwapImg('BTN_date', 'img_Date_UP',true);" onclick="calSwapImg('BTN_date', 'img_Date_DOWN');showCalendar('new_get_1_free','dteWhen','BTN_date');return false;"><?php echo tep_image(DIR_WS_IMAGES . 'cal_date_up.gif', 'Calendar', '22', '17', 'align="absmiddle" name="BTN_date"'); ?></a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            ?>
                <td class="dataTableContent" width="50%"><?php echo $get_1_free['products_name']; ?></td>
