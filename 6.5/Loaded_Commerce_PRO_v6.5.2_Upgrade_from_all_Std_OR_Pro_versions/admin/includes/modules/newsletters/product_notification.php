...
$choose_audience_string .= '<table border="0" width="100%" cellspacing="0" cellpadding="2" align="center"  >' . "\n" .
                                 '  <tr>' . "\n" .
...
/************************/
      ...
      //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        $str_mail_query = "select distinct pn.customers_id, c.customers_firstname, c.customers_lastname, c.customers_email_address from " . TABLE_CUSTOMERS . " c, " . TABLE_PRODUCTS_NOTIFICATIONS . " pn where c.customers_id = pn.customers_id and pn.date_added >= '".$s_date."' and pn.date_added <= '".$e_date."' and pn.products_id in (" . $ids . ") ";
    ...
    function send($newsletter_id) {
      ...
      if (isset($_POST['global']) && ($_POST['global'] == 'true')) {
          /****************/                 
       $str_mail_query = "select distinct pn.products_id, pn.customers_id, c.customers_firstname, c.customers_lastname, c.customers_email_address from " . TABLE_CUSTOMERS . " c, " . TABLE_PRODUCTS_NOTIFICATIONS . " pn where c.customers_id = pn.customers_id"; 
       $products_query = tep_db_query($str_mail_query);
        ...
        $str_mail_query = "select distinct pn.products_id, pn.customers_id, c.customers_firstname, c.customers_lastname, c.customers_email_address from " . TABLE_CUSTOMERS . " c, " . TABLE_PRODUCTS_NOTIFICATIONS . " pn,orders o, orders_products op where c.customers_id = pn.customers_id and pn.date_added >= '".$s_date."' and pn.date_added <= '".$e_date."' and pn.products_id in (" . $ids . ") and o.orders_id = op.orders_id and o.customers_id = c.customers_id and op.products_id in (" . $ids . ")";
        $products_query = tep_db_query($str_mail_query);
        ...
        $chosen = $_POST['chosen'];
        $ids = implode(',', $chosen);       
        $str_mail_query = "select distinct pn.products_id, pn.customers_id, c.customers_firstname, c.customers_lastname, c.customers_email_address from " . TABLE_CUSTOMERS . " c, " . TABLE_PRODUCTS_NOTIFICATIONS . " pn where c.customers_id = pn.customers_id and pn.date_added >= '".$s_date."' and pn.date_added <= '".$e_date."' and pn.products_id in (" . $ids . ") ";
      ...
      $str_prod_link = '<br>';
      foreach($arr_prod as $link_products_id) {
          $str_prod_link .= "<a href = '".HTTP_CATALOG_SERVER.DIR_WS_HTTP_CATALOG."product_info.php?products_id=" . $link_products_id . "'>".HTTP_CATALOG_SERVER.DIR_WS_HTTP_CATALOG."product_info.php?products_id=".$link_products_id."</a><br>";
      }
