                  ...
                  <td valign="top">
                    <table border="0" width="100%" cellspacing="0" cellpadding="2" class="data-table">
                      <tr class="dataTableHeadingRow">
                        <td class="dataTableHeadingContent"><a href="<?php echo "$PHP_SELF?viewedSort=lastname-asc" . $oscid; ?>" title="<?php echo TABLE_HEADING_SORT . TABLE_HEADING_LASTNAME . TABLE_HEADING_SORT_UA; ?>">+</a>&nbsp;<?php echo TABLE_HEADING_LASTNAME; ?>&nbsp;<a href="<?php echo "$PHP_SELF?viewedSort=lastname-desc" . $oscid; ?>" title="<?php echo TABLE_HEADING_SORT . TABLE_HEADING_LASTNAME . TABLE_HEADING_SORT_DA; ?>">-</a></td>
                        <td class="dataTableHeadingContent"><a href="<?php echo "$PHP_SELF?viewedSort=firstname-asc" . $oscid; ?>" title="<?php echo TABLE_HEADING_SORT . TABLE_HEADING_FIRSTNAME . TABLE_HEADING_SORT_UA; ?>">+</a>&nbsp;<?php echo TABLE_HEADING_FIRSTNAME; ?>&nbsp;<a href="<?php echo "$PHP_SELF?viewedSort=firstname-desc" . $oscid; ?>" title="<?php echo TABLE_HEADING_SORT . TABLE_HEADING_FIRSTNAME . TABLE_HEADING_SORT_DA; ?>">-</a></td>
                        <td class="dataTableHeadingContent"><a href="<?php echo "$PHP_SELF?viewedSort=date-asc" . $oscid; ?>" title="<?php echo TABLE_HEADING_SORT . TABLE_HEADING_DOB . TABLE_HEADING_SORT_U1; ?>">+</a>&nbsp;<?php echo TABLE_HEADING_DOB; ?>&nbsp;<a href="<?php echo "$PHP_SELF?viewedSort=date-desc" . $oscid; ?>" title="<?php echo TABLE_HEADING_SORT . TABLE_HEADING_DOB . TABLE_HEADING_SORT_D1; ?>">-</a></td>
				                    <td class="dataTableHeadingContent" align="right"><a href="<?php echo "$PHP_SELF?viewedSort=points-asc" . $oscid; ?>" title="<?php echo TABLE_HEADING_SORT . TABLE_HEADING_POINTS . TABLE_HEADING_SORT_U1; ?>">+</a>&nbsp;<?php echo TABLE_HEADING_POINTS; ?>&nbsp;<a href="<?php echo "$PHP_SELF?viewedSort=points-desc" . $oscid; ?>" title="<?php echo TABLE_HEADING_SORT . TABLE_HEADING_POINTS . TABLE_HEADING_SORT_D1; ?>">-</a></td>                
                        <td class="dataTableHeadingContent" align="right"><?php echo TABLE_HEADING_POINTS_VALUE; ?></td>
                        <td class="dataTableHeadingContent" align="right"><a href="<?php echo "$PHP_SELF?viewedSort=expires-asc" . $oscid; ?>" title="<?php echo TABLE_HEADING_SORT . TABLE_HEADING_POINTS_EXPIRES . TABLE_HEADING_SORT_U1; ?>">+</a>&nbsp;<?php echo TABLE_HEADING_POINTS_EXPIRES; ?>&nbsp;<a href="<?php echo "$PHP_SELF?viewedSort=expires-desc" . $oscid; ?>" title="<?php echo TABLE_HEADING_SORT . TABLE_HEADING_POINTS_EXPIRES . TABLE_HEADING_SORT_D1; ?>">-</a></td>
                        <td class="dataTableHeadingContent" align="right"><?php echo TABLE_HEADING_POINTS_IP; ?></td>
                      ...
                      <?php
                        ...
                        //sort view  bof
                        $customers_query_raw = "SELECT customers_id, customers_gender, customers_lastname, customers_firstname, customers_dob, customers_email_address, customers_shopping_points, customers_points_expires, customers_points_ip from " . TABLE_CUSTOMERS . " " . $search . " " . $filter . " ORDER BY $sort";
                      ...
                      ?>
                        ...
                        <td class="dataTableContent" align="right"><?php echo $customers['customers_points_ip']; ?></td>
